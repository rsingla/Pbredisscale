...
public final class ProfileListProto {
	...
	public interface ProfileListOrBuilder extends
		 ...
		 */
		java.util.List<ProfileProto.Profile> getProfilesList();

		/**
		 * <code>repeated .Profile profiles = 1;</code>
		 */
		ProfileProto.Profile getProfiles(int index);
		 ...
		 * <code>repeated .Profile profiles = 1;</code>
		 */
		java.util.List<? extends ProfileProto.ProfileOrBuilder> getProfilesOrBuilderList();

		/**
		 * <code>repeated .Profile profiles = 1;</code>
		 */
		ProfileProto.ProfileOrBuilder getProfilesOrBuilder(int index);
	}

	/**
	 * Protobuf type {@code ProfileList}
	 */
	public static final class ProfileList extends com.google.protobuf.GeneratedMessageV3 implements
		...
		private ProfileList(com.google.protobuf.CodedInputStream input,
				...
				while (!done) {
					...
					case 10: {
						if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
							profiles_ = new java.util.ArrayList<ProfileProto.Profile>();
							mutable_bitField0_ |= 0x00000001;
						}
						profiles_.add(input.readMessage(ProfileProto.Profile.parser(), extensionRegistry));
						break;
					}
					default: {
		...
		protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
			return ProfileListProto.internal_static_ProfileList_fieldAccessorTable.ensureFieldAccessorsInitialized(
		...
		private java.util.List<ProfileProto.Profile> profiles_;

		/**
		 * <code>repeated .Profile profiles = 1;</code>
		 */
		public java.util.List<ProfileProto.Profile> getProfilesList() {
			return profiles_;
		}
		 ...
		 * <code>repeated .Profile profiles = 1;</code>
		 */
		public java.util.List<? extends ProfileProto.ProfileOrBuilder> getProfilesOrBuilderList() {
			return profiles_;
		}
		 ...
		 * <code>repeated .Profile profiles = 1;</code>
		 */
		public ProfileProto.Profile getProfiles(int index) {
		 ...
		 * <code>repeated .Profile profiles = 1;</code>
		 */
		public ProfileProto.ProfileOrBuilder getProfilesOrBuilder(int index) {
			return profiles_.get(index);
		}
		...
		public static ProfileListProto.ProfileList parseFrom(java.nio.ByteBuffer data)
				throws com.google.protobuf.InvalidProtocolBufferException {
		...
		public static ProfileListProto.ProfileList parseFrom(com.google.protobuf.ByteString data)
				throws com.google.protobuf.InvalidProtocolBufferException {
			return PARSER.parseFrom(data);
		}
		...
		public static ProfileListProto.ProfileList parseFrom(java.io.InputStream input) throws java.io.IOException {
		...
		public static ProfileListProto.ProfileList parseFrom(com.google.protobuf.CodedInputStream input)
				throws java.io.IOException {
			return com.google.protobuf.GeneratedMessageV3.parseWithIOException(PARSER, input);
		}
		...
		public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
			...
			public Builder mergeFrom(ProfileListProto.ProfileList other) {
				if (other == ProfileListProto.ProfileList.getDefaultInstance())
					return this;
				if (profilesBuilder_ == null) {
					...
					if (!other.profiles_.isEmpty()) {
						if (profilesBuilder_.isEmpty()) {
							...
							profiles_ = other.profiles_;
							bitField0_ = (bitField0_ & ~0x00000001);
							profilesBuilder_ = com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders
									? getProfilesFieldBuilder()
									: null;
						} else {
			...
			private java.util.List<ProfileProto.Profile> profiles_ = java.util.Collections.emptyList();

			private void ensureProfilesIsMutable() {
				if (!((bitField0_ & 0x00000001) == 0x00000001)) {
					profiles_ = new java.util.ArrayList<ProfileProto.Profile>(profiles_);
					bitField0_ |= 0x00000001;
				}
			}

			private com.google.protobuf.RepeatedFieldBuilderV3<ProfileProto.Profile, ProfileProto.Profile.Builder, ProfileProto.ProfileOrBuilder> profilesBuilder_;
			 ...
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public Builder setProfiles(int index, ProfileProto.Profile value) {
				if (profilesBuilder_ == null) {
					if (value == null) {
			 ...
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public Builder setProfiles(int index, ProfileProto.Profile.Builder builderForValue) {
				if (profilesBuilder_ == null) {
					ensureProfilesIsMutable();
			 ...
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public Builder addProfiles(ProfileProto.Profile value) {
				if (profilesBuilder_ == null) {
					if (value == null) {
						throw new NullPointerException();
					}
			 ...
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public Builder addProfiles(int index, ProfileProto.Profile value) {
				if (profilesBuilder_ == null) {
					if (value == null) {
						throw new NullPointerException();
					}
			 ...
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public Builder addProfiles(ProfileProto.Profile.Builder builderForValue) {
				if (profilesBuilder_ == null) {
					ensureProfilesIsMutable();
			 ...
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public Builder addProfiles(int index, ProfileProto.Profile.Builder builderForValue) {
				if (profilesBuilder_ == null) {
					ensureProfilesIsMutable();
			 ...
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public Builder addAllProfiles(java.lang.Iterable<? extends ProfileProto.Profile> values) {
				if (profilesBuilder_ == null) {
					ensureProfilesIsMutable();
			 ...
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public ProfileProto.Profile.Builder getProfilesBuilder(int index) {
			 ...
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public ProfileProto.Profile.Builder addProfilesBuilder() {
				return getProfilesFieldBuilder().addBuilder(ProfileProto.Profile.getDefaultInstance());
			}

			/**
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public ProfileProto.Profile.Builder addProfilesBuilder(int index) {
				return getProfilesFieldBuilder().addBuilder(index, ProfileProto.Profile.getDefaultInstance());
			}

			/**
			 * <code>repeated .Profile profiles = 1;</code>
			 */
			public java.util.List<ProfileProto.Profile.Builder> getProfilesBuilderList() {
				return getProfilesFieldBuilder().getBuilderList();
			}

			private com.google.protobuf.RepeatedFieldBuilderV3<ProfileProto.Profile, ProfileProto.Profile.Builder, ProfileProto.ProfileOrBuilder> getProfilesFieldBuilder() {
				if (profilesBuilder_ == null) {
					profilesBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<ProfileProto.Profile, ProfileProto.Profile.Builder, ProfileProto.ProfileOrBuilder>(
							profiles_, ((bitField0_ & 0x00000001) == 0x00000001), getParentForChildren(), isClean());
					profiles_ = null;
				}
		...
		private static final com.google.protobuf.Parser<ProfileList> PARSER = new com.google.protobuf.AbstractParser<ProfileList>() {
			@java.lang.Override
			public ProfileList parsePartialFrom(com.google.protobuf.CodedInputStream input,
					com.google.protobuf.ExtensionRegistryLite extensionRegistry)
					throws com.google.protobuf.InvalidProtocolBufferException {
	...
	private static final com.google.protobuf.Descriptors.Descriptor internal_static_ProfileList_descriptor;
	private static final com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internal_static_ProfileList_fieldAccessorTable;
	...
	static {
		java.lang.String[] descriptorData = { "\n\016Profiles.proto\032\rProfile.proto\")\n\013Profi"
				+ "leList\022\032\n\010profiles\030\001 \003(\0132\010.ProfileB\022B\020Pr"
				+ "ofileListProtob\006proto3" };
		...
		com.google.protobuf.Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(descriptorData,
				new com.google.protobuf.Descriptors.FileDescriptor[] { ProfileProto.getDescriptor(), }, assigner);
		internal_static_ProfileList_descriptor = getDescriptor().getMessageTypes().get(0);
		internal_static_ProfileList_fieldAccessorTable = new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
				internal_static_ProfileList_descriptor, new java.lang.String[] { "Profiles", });
